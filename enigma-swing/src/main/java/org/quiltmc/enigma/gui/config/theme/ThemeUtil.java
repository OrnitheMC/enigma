...
public final class ThemeUtil {
	...
	public static BoxHighlightPainter createNameWarningPainter() {
		return BoxHighlightPainter.create(Config.getCurrentSyntaxPaneColors().nameWarning.value(), Config.getCurrentSyntaxPaneColors().nameWarningOutline.value());
	}
