...
public class KeybindingsBase {
    public enum Category {
        SEARCH("key.category.search"),
        EDITOR("key.category.editor"),
        GENERAL("key.category.keybindings");

        private final String name;

        private Category(String translatableText) {
    ...
    public enum Keybindings {
        ...
        private Keybindings(Category category, String translatableText, int keyCode, int modifiers) {
